<%-- 
    Document   : UDeBodega
    Created on : 21/03/2023, 10:38:22
    Author     : branp
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            ResultSet Rs = cn.IniciarConexion().executeQuery("select * from Usuarios WHERE Tipo = 'Bodega';");
            ...
            <div class="contenedorPrincipal">
                <div class='divSeparador'>   
                    <form action="" >
                        ...
                        <div class="divSeparadorInterno">    
                            <h1>Los usuarios de bodega son:</h1>
                                <%
                                ...
                                out.println("<td>Tiendas de las que se encarga:</td>");
                                out.println("</tr>");
                                while (Rs.next()) {
                                    ...
                                    out.println("<td>"+ email +"</td>");
                                    ResultSet Tiendas = cn.IniciarConexion().executeQuery("select * from TiendasDeUsuariosDeBodega WHERE CodigoDeEncargado = '"+codigo+"';");
                                    while(Tiendas.next()){
                                        tienda += " | "+String.valueOf(Tiendas.getInt("CodigoDeTienda"));    
                                    }
                                    out.println("<td>"+ tienda +"</td>");
                                    out.println("<td><a href='UDeBodegaModificar.jsp?codigo=" + codigo + "'>Modificar</a></td>");
                                    out.println("<td><a href='UDeBodega.jsp?Eliminar=" + codigo + "'>Eliminar</a></td>");
                                    out.println("</tr>");
                                }
                                out.println("</table>");
                            %>  
        ...
        <%
            if(!(request.getParameter("Eliminar")==null)){
                ...
                out.print("<script>location.replace('UDeBodegaCrearCodigo.jsp');</script>");
            }
        %>  
    </body>
</html>
